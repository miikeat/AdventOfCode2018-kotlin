fun main() {
    ...
    for (id in data2) {
        ...
        if (count.containsValue(2)) double++
        if (count.containsValue(3)) tripple++
    }
    println (double * tripple)
}

val data2 = """pbopcmjeizuhxlqnwasfgtycdm
...
kbokrmjeizuhxlqnwasfgzjcdv""".split('\n')